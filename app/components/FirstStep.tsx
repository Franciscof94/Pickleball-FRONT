  ...
  return (
    <section className="max-w-[855px] mx-auto min-h-[533px]">
      ...
      <div className="relative">
        ...
        <div className="mt-3 md:absolute lg:absolute lg:h-18 md:h-18 lg:min-w-[439px] md:min-w-[439px] grid justify-items-center  right-[60px] md:right-[37px] lg:bottom-[-15px] md:bottom-[-15px]">
